# CavityCoolRabiDataRun_SBscan.py
# Forked from CavityCoolRabiDataRun_0deg_Doppler_SteadyState.py by Hans on 2011-07-18
# Cavity Cooling with 0deg beam from the Doppler limit and down to (hopefully steady state) and then try this at various Cavity Detuning frequencies.
...
#                CavityOnDF_list = [CavityOnDF_value]
                delta=0.050
                CavityOnDF_list=CavityOnDF_value+sp.array([0,2*delta,-2*delta,-delta,delta,-delta/2,delta/2,delta/4,-delta/4])
