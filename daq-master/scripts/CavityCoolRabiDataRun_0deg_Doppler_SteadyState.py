...
#                EndT = 200.
                    ...
                    if not(alreadyRan(dirname, filename)):
                        ...
                        CavityCoolRabi_0deg_Doppler(filename, dirname, StartT, EndT, CavityOnDF, ReadoutDF, ScanPoints, ScanRepeat, LockOption, CavLockOn, ProbeLockOn, ProbeSet, IonLockOn, IonSet)
    ScanDone()
