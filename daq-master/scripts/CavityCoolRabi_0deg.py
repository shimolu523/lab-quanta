# CavityCoolRabi_0deg.py
# Forked by Hans on 2011-06-22 to do Cavity Cooling in 0 degree set up.
# Changes in beams are made to reflect this.
ARGS = ['StartT', 'EndT', 'CavityOnDF', 'ReadoutDF', 'ScanPoints', 'ScanRepeat', 'LockOption', 'CavLockOn', 'ProbeLockOn', 'ProbeSet','ProbeSet_SB', 'IonLockOn', 'IonSet']

import Stabilization
import CavityStabilization

def RunScript(filename, dirname, StartT, EndT, CavityOnDF, ReadoutDF, ScanPoints, ScanRepeat, LockOption, CavLockOn, ProbeLockOn, ProbeSet, ProbeSet_SB, IonLockOn, IonSet):
    CavityCoolRabi_0deg(filename, dirname, StartT, EndT, CavityOnDF, ReadoutDF, ScanPoints, ScanRepeat, LockOption, CavLockOn, ProbeLockOn, ProbeSet,ProbeSet_SB, IonLockOn, IonSet)

def CavityCoolRabi_0deg(filename, dirname, StartT, EndT, CavityOnDF, ReadoutDF, ScanPoints, ScanRepeat, LockOption, CavLockOn, ProbeLockOn, ProbeSet, ProbeSet_SB, IonLockOn, IonSet):
...
#           plotLabel = ['BlueCav', 'RedCenter', 'RedPiTime', 'RedCenter'][LockOption]
        ...
        print time.strftime('%H:%M:%S'),__file__,"Exception occurred in RunScript:", e
        traceback.print_exc()
